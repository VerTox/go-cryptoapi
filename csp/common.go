...
#cgo linux,arm64 CFLAGS: -I/opt/cprocsp/include/cpcsp -DUNIX -DLINUX -DSIZEOF_VOID_P=8
...
#cgo linux,arm64 LDFLAGS: -L/opt/cprocsp/lib/aarch64/ -lcapi10 -lcapi20 -lrdrsup -lssp
